...
<title>Event2Act Executive Report</title>
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .brand-dot { width: 32px; height: 32px; border-radius: 8px; overflow: hidden; display: flex; align-items: center; justify-content: center; }
...
<div class="page">
  ...
  <div class="report-footer">
    <span>Generated by Event2Act · ${dateStr}</span>
...
export function downloadReport(
  ...
  a.href      = url;
  a.download  = `Event2Act-Report-${date}.html`;
