...
import {
  ...
  BarChart3, RotateCcw, Settings, LogOut, Upload, X, ShieldCheck
} from "lucide-react";
      ...
      <aside className={cn(
        ...
        <div className="px-2 py-3 border-t border-white/5 space-y-2">
          ...
          <button
            ...
            className="w-full flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs text-slate-500 hover:text-white hover:bg-white/5 transition-colors"
          >
