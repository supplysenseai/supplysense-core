...
export function ValidationProgress({
  ...
  useEffect(() => {
    if (isDone && result?.success) setCountdown(REDIRECT_DELAY);
        ...
        <>
          ...
          <div className="mx-4 mb-3 p-3 rounded-xl bg-emerald-500/8 border border-emerald-500/15">
            <div className="flex flex-wrap items-center gap-2 mb-3">
              ...
              <span className="sm:ml-auto text-[11px] text-slate-500">
          ...
          <div className="px-4 pb-4 flex flex-col gap-2">
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              <button onClick={onReset}
                className="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl bg-white/6 hover:bg-white/10 text-white text-sm transition-colors">
